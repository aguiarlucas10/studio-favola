...
// Deriva o mes_ano (formato legado 01/MM/YYYY) a partir de uma data ISO (YYYY-MM-DD).
// Substitui o campo "Mês/Ano" digitado à mão. Cai no mês atual se a data for inválida/vazia.
